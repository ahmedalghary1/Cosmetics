...
4. من **لوحة التحكم ← إعدادات المتجر** أضف معرّفات GA4 وMeta Pixel وTikTok Pixel عند الحاجة. عند ضبطها يتتبع المتجر مشاهدة المنتج والإضافة للسلة وبدء الدفع والشراء دون إرسال بيانات العميل الشخصية.
5. فعّل رسائل الطلب والعودة للمخزون من الصفحة نفسها، واضبط SMTP في `.env` حتى تصل الرسائل فعليًا.
6. اختبر رفع ملفات Media على الاستضافة.
7. أنشئ نسخة احتياطية دورية من قاعدة البيانات وMedia.
