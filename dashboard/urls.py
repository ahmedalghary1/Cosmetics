...
urlpatterns = [
    ...
    path("exports/<str:report>.csv", views.export_csv, name="export_csv"),
    ...
    path("inventory/batches/", views.batch_list, name="batches"),
    path("inventory/batches/add/", views.batch_form, name="batch_add"),
    path("inventory/batches/<int:pk>/edit/", views.batch_form, name="batch_edit"),
    path("variant-options/", views.variant_option_list, name="variant_options"),
    path("variant-options/add/", views.variant_option_form, name="variant_option_add"),
    path("variant-options/<int:pk>/edit/", views.variant_option_form, name="variant_option_edit"),
    path("products/<int:product_pk>/variants/", views.variant_list, name="variants"),
    path("products/<int:product_pk>/variants/add/", views.variant_form, name="variant_add"),
    path("products/<int:product_pk>/variants/<int:pk>/edit/", views.variant_form, name="variant_edit"),
    ...
    path("orders/<int:pk>/payment-receipt/", views.payment_receipt, name="payment_receipt"),
    ...
    path("offers/add/", views.offer_form, name="offer_add"),
